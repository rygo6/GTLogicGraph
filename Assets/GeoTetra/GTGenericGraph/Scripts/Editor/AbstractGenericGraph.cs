...
{
    [Serializable]
    public abstract class AbstractGenericGraph : IGraph, ISerializationCallbackReceiver, IGenerateProperties
    {
        ...
        [NonSerialized]
        List<AbstractGenericNode> m_Nodes = new List<AbstractGenericNode>();
...
//        }
        ...
        public virtual void OnAfterDeserialize()
        {
            ...
            m_Nodes = new List<AbstractGenericNode>(nodes.Count);
            m_NodeDictionary = new Dictionary<Guid, INode>(nodes.Count);
            foreach (var node in nodes.OfType<AbstractGenericNode>())
            {
                node.owner = this;
